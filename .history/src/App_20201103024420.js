      ...
      <div>
        ...
        <div className="todo-section">
          <div className="input-fields">
            ...
            <input type="text" className="input-text"  placeholder="Enter task" id="input-text" value={this.state.newItem} onChange={e => this.updatedItem(e.target.value)} required /><button className="add-task" on> Add Task</button>
          </div>
